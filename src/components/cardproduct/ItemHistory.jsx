        ...
        <div className="flex flex-col gap-4">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 lg:p-8">
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 cursor-pointer">
                {/* Image Section */}
                <div className="flex-shrink-0">
                  <div className="relative w-full lg:w-28 h-32 lg:h-28 rounded-xl overflow-hidden bg-gray-100 shadow-md ">
                    <img
                      src={item.image}
                      alt={item.name}
                ...
                <div className="flex-1 flex flex-col justify-between gap-6">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="ml-10 lg:ml-0">
                        <span className="inline-flex items-center gap-1.5 bg-brand px-3 py-1.5 text-white rounded-full text-xs lg:text-sm font-medium shadow-md">
                  ...
                  <div className=" flex justify-end pt-2 border-t border-gray-100">
                    <button
                      className="cursor-pointer inline-flex items-center gap-2 text-amber-700 hover:text-brand font-medium text-sm lg:text-base"
                      onClick={handleViewDetail}
                    >
                      <span className="relative text-brand ">
                        View Order Detail
                        <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-brand"></span>
                      </span>
                      <ArrowRight size={18} />
                    </button>
                  </div>
