...
function NavbarAdmin() {
  ...
  return (
    <>
      <nav className="border-b w-full bg-gray-100 flex justify-between px-5 py-5 md:px-15 lg:px-30 duration-100">
        <div className="flex gap-35">
          <div className="flex gap-3">
            <img src="/iconv2.svg" alt="" class="coklat" />
            <img src="/logov2.svg" alt="" class="coklat" />
          </div>
        </div>
